...
impl PouIndexEntry {
    ...
    pub fn create_function_entry(name: &str, return_type: &str) -> PouIndexEntry {
...
impl Index {
    ...
    pub(self) fn find_implementation_by_name(&self, call_name: &str) -> Option<&ImplementationIndexEntry> {
